...
public class Deciduous_FieldGuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get firebase reference for just deciduous.
        ...
        // Using Firebase UI library to list all the deciduous plants (species name, common name)
        FirebaseRecyclerAdapter speciesUIAdapter = new FirebaseRecyclerAdapter<deciduousDetails, deciduousHolder>(deciduousDetails.class, speciesnamelist, deciduousHolder.class, deciduousRef)
        {
            @Override
            protected void populateViewHolder(deciduousHolder holder, deciduousDetails speciesnameobj, int position)
            {
