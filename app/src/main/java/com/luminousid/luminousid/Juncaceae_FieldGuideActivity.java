...
public class Juncaceae_FieldGuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get firebase reference for just juncaceae family of graminoids.
        ...
        FirebaseRecyclerAdapter speciesUIAdapter = new FirebaseRecyclerAdapter<juncaceaeDetails, juncaceaeHolder>(juncaceaeDetails.class, speciesnamelist, juncaceaeHolder.class, juncaRef)
        {
            @Override
            protected void populateViewHolder(juncaceaeHolder holder, juncaceaeDetails speciesnameobj, int position)
            {
