...
public class Poaceae_FieldGuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get firebase reference for just poaceae family of graminoids.
        ...
        FirebaseRecyclerAdapter speciesUIAdapter = new FirebaseRecyclerAdapter<poaceaeDetails, poaceaeHolder>(poaceaeDetails.class, speciesnamelist, poaceaeHolder.class, poaRef)
        {
            @Override
            protected void populateViewHolder(poaceaeHolder holder, poaceaeDetails speciesnameobj, int position)
            {
