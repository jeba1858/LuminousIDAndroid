...
public class poaceaeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    View mView;
    Context mContext;

    public poaceaeHolder(View itemView){
        super(itemView);
        mView = itemView;
    ...
    public void bindPlant(poaceaeDetails species){
    ...
    public void onClick(View view){
        final ArrayList<poaceaeDetails> species = new ArrayList<>();
        ...
        poaRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    species.add(snapshot.getValue(poaceaeDetails.class));
                }
                ...
                poaceaeDetails poaPlant = species.get(itemPosition);
