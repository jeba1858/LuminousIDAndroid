...
public class juncaceaeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    View mView;
    Context mContext;

    public juncaceaeHolder(View itemView){
        super(itemView);
        mView = itemView;
    ...
    public void bindPlant(juncaceaeDetails species){
    ...
    public void onClick(View view){
        final ArrayList<juncaceaeDetails> species = new ArrayList<>();
        ...
        juncaRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    species.add(snapshot.getValue(juncaceaeDetails.class));
                }
                ...
                juncaceaeDetails juncaPlant = species.get(itemPosition);
